defmodule Jukee.Accounts do
  ...
  def get_current_token(conn) do
    JukeeWeb.Guardian.Plug.current_token(conn)
  end

  def sign_out(conn) do
    JukeeWeb.Guardian.Plug.sign_out(conn)
  end

  def get_claims(conn) do
    JukeeWeb.Guardian.Plug.current_claims(conn)
  end

  def refresh_token(jwt) do
    JukeeWeb.Guardian.refresh(jwt)
  end

  def get_current_user(conn) do
    JukeeWeb.Guardian.Plug.current_resource(conn)
  end

  def sign_in_user(conn, user) do
    JukeeWeb.Guardian.Plug.sign_in(conn, user)
  end
